        ...
        <div className="mx-auto grid max-w-7xl grid-cols-1 items-center gap-16 px-4 md:grid-cols-2">
          ...
          >
            ...
            <motion.p
              ...
              className="mb-8 font-sans text-[0.9rem] leading-[1.85] text-white/50"
            >
              With future versions, that ecosystem will expand further —
              gesture-based robotics control, neuroadaptive XR training, and
              silent communication in covert environments. Wearable technology
              with a purpose beyond tracking your steps.
            </motion.p>
            <motion.div
              initial={{ opacity: 0, y: 8 }}
              whileInView={{ opacity: 1, y: 0 }}
